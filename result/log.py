...
#     log.logger.info("用例编号====>")
#     log.logger.info("用例标题====>")
#     log.logger.info("请求方式====>")
#     log.logger.info("请求地址====>")
#     log.logger.info("请求头====>{}")
#     log.logger.info("请求参数====>")
#     # log.logger.info("Cookies====>{}".format(dumps(cookies,indent=4)))
#     log.logger.info("接口响应状态码====>")
#     log.logger.info("接口响应体为====>{}")
#     # Logger('{}_ERROR.log'.format(now), level='error').logger.error('error')